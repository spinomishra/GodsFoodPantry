...
public class ConsumerTableModel extends RowTableModel<Consumer> {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return consumer.getDateOfBirth();
            case 3:
                return consumer.getContactNumber();
            case 4:
                return consumer.getAddress();
            case 5:
                return Identity.IDType.values()[consumer.getIdentityInfo().IdentityType].toString();
            case 6:
                return consumer.getIdentityInfo().Number;
            case 7:
                return consumer.getIdentityInfo().IssuedOn;
            case 8:
                return consumer.getIdentityInfo().ExpiresOn;
            case 9:
                return consumer.isGroupFlagged() ? "Yes" : "No";
            case 10:
                return consumer.getGroupMemberCount();
            default:
                return null;
        }
    }
